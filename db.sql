...
ISERT INTO django_content_type VALUES(2,'auth','permission');
...
CREATE TABLE IF NOT EXISTS "pages_message" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "content" text NOT NULL, "time" datetime NOT NULL,
    "source_id" integer NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED,
    "target_id" integer NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED
);
...
INSERT INTO auth_user VALUES(
    1,
    'pbkdf2_sha256$180000$TBOH2yAWx4qE$F586qFabIZ/etSV5K53EK0aLKv3dFRNhEVCUO+QmDQA=',
    '2020-07-18 23:04:23.403371',
    1,
    'admin',
    '',
    'admin@admin.gov',
